class Game {
  ...
  start() {
    ...
    var obstacle1Positions = [
      ...
      { x: width / 2 - 150, y: height - 5800, image: obstacle1Image },
      { x: width / 2, y: height - 6800, image: obstacle1Image },
      { x: width / 2 - 150, y: height - 7300, image: obstacle1Image },
      { x: width / 2, y: height - 7800, image: obstacle1Image }
    ];
    ...
    var obstacle2Positions = [
      ...
      { x: width / 2 + 250, y: height - 5800, image: obstacle2Image },
      { x: width / 2 - 180, y: height - 6500, image: obstacle2Image },
      { x: width / 2 + 250, y: height - 4000, image: obstacle2Image },
      { x: width / 2 - 180, y: height - 6000, image: obstacle2Image }
    ];
    ...
    this.addSprites(powerCoins, 27, powerCoinImage, 0.09);
  ...
  showRank() {
    swal({
      ...
      imageUrl:
        "https://i.pinimg.com/originals/76/46/3f/76463fbed13fb15eb880f1cb00b8d9b2.png",
      imageSize: "100x100",
  ...
  gameOver() {
    swal({
      ...
      imageUrl:
        "https://i.pinimg.com/originals/e7/d8/a6/e7d8a6578943987088654dfae64ad18c.png",
